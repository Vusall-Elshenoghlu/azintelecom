export const az = {
    ...
    home_activities_citizen: 'Vətəndaş',
    home_activities_citizen_desc: 'Orci faucibus consequat a integer aliquet. Mi pharetra porta scelerisque',
    home_activities_owner: 'Fərdi sahibkar',
    home_activities_legal_person: 'Hüquqi şəxs',
    home_activities_government: 'Dövlət qurumları',
    home_activities_image_alt: 'about pictura',
    home_activites_heading: 'Gələcəyin formalaşmasına şahid olun',
    home_activities_description: 'Dövlət və biznes qurumlarının elektronlaşmış xidmətləri',
    // Advantages
    home_advantages_title: 'Üstünlüklərimiz',
    home_advantages_description: 'Lorem ipsum dolor sit amet',
    home_advantages_description2: 'Azərbaycan Respublikasının vətəndaşları üçün SİMA İMZA və SİMA Token məhsulunu qarşılayın',
    home_advantages_experience: 'Təcrübə',
    home_advantages_innovation: 'innovasiya',
    ...
    about_achievements_description: 'We believe in the future where\n' +
        'technology leads',
    about_achievements_sponsor: 'Yerli və beynəlxalq tərəfdaş',
    about_achievements_sponsor_count: '1000+',
    about_achievements_area: 'Kvadrat metr server sahəsi',
    about_achievements_area_count: '2100+',
    about_achievements_specialist: 'Peşəkar mütəxəssis',
    about_achievements_specialist_count: '400+',
    about_achievements_sertificates: 'Beynəlxalq sertifikat',
    about_achievements_sertificates_count: '7',
    ...
    //Structure
    about_structure_title: 'Struktur',
    about_structure_description: 'Komandamızı tanıyın',
    about_structure_team_employer1: 'Elkhan Azizov',
    about_structure_team_employer1_prof: 'Chairman of the Board of Directors',
    about_structure_team_employer2: 'Sadig Yolchuyev',
    about_structure_team_employer2_prof: 'Adviser of Chairman',
    about_structure_team_employer3: 'Altay Ismayilov',
    ...
    footer_account: 'Hesabatlar',
    footer_contact_company: 'info@azintelecom.az',
    footer_contact_company_job: 'jobs@azintelecom.az',
    footer_phone_company: '+994  12  200  00  20',
    footer_location: 'Location of company',
    footer_address_line1: 'Azərbaycan, Bakı şəhəri, Nizami',
    footer_address_line2: 'Nizami rayonu, Əlibəy Hüseynzadə küç., 74',
    footer_copyright: 'Copyright Ⓒ ',
    footer_author: ' Javidan Nasib',
    footer_write_us: 'Bizə yaz!',
    footer_join_us: 'Bizə qoşul!',
